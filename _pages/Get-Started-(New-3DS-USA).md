...
|:-:|:-:|:-:|:-:|
| 9.0.0 | 10.7.0 | [Homebrew Launcher (не используя браузер)](Homebrew-launcher-(no-browser)) | [Homebrew Launcher (используя браузер)](Homebrew-launcher-(browser)) |
