...
header:
  ...
  cta_url: "/get-started"
  caption:
excerpt: 'Полное руководство по прошивке 3DS, <br /> от начала до arm9loaderhax.<br /><br />**Актуализировал к версии гайда от Plailect<br />20.01.2017<br /><br />**'
---

<a name="start" />

**Те кто следит за сценой, знают, что Plailect добавляет переводы на другие языки в свой гайд. Русский, основанный на этом форке, там тоже будет. Это руководство - форк, созданный из-за несогласия в некоторых решениях в оригинальном гайде, например, об отказе от внешних ссылкой на русскоязычные инструкции. Форк будет развиваться параллельно основному гайду и будет заимствовать местами формулировки и строки оттуда. Все, кто переводил тот гайд отмечены в [соответствующем разделе](credits).**
{: .notice--success}
