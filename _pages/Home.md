...
header:
  ...
  cta_url: "/get-started"
  caption:
excerpt: 'Полное руководство по прошивке 3DS, <br /> от начала до boot9strap.<br /><br />**Последнее изменение: <br />21 мая 2017<br /><br />**'
---
<a name="start" />
...
Кастомную прошивку можно легко установить на любую приставку с версией прошивки 11.4.0 или ниже.
...
+ Инструкция предназначена для New 3DS, Old 3DS и 2DS любых регионов на прошивке 11.4.0 или ниже *(за исключением консолей CHN / TWN регионов)*.
