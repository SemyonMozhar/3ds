...
header:
  ...
  cta_url: "/get-started"
  caption:
excerpt: 'Полное руководство по прошивке 3DS, <br /> от начала до boot9strap.<br /><br />**Последнее изменение: <br />26 июня 2017<br /><br />**'
---
<a name="start" />
...
+ Инструкция предназначена для New 3DS, New 2DS, Old 3DS и Old 2DS любых регионов на прошивке 11.4.0 или ниже
