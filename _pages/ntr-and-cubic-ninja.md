...
* Свежая версия [SafeCtrTransferWIP](https://github.com/d0k3/SafeCtrTransferWIP/releases/latest)
...
1. Скопируйте папку `SafeCTRTransferWIP` из `.zip-архива` SafeCTRTransferWIP в папку `/3ds/` на SD-карте
