...
Поскольку чаще всего к ctrtransfer 9.2.0 прибегают при возникновении трудностей с бекапом NAND (или полном его отсутствии), при переносе мы будет делать только бекап тикетов и сейвов конфига. ctrtransfer is to troubleshoot issues caused by the existing NAND, these steps, unlike the 2.1.0 ctrtransfer, will have you backup only the tickets and config save. Failure to back these up will result in the LOSS of all installed games and saves!
{: .notice--danger}
...
##### <a name="part4" />Часть IV - Восстановление конфигов
