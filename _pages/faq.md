...
**О:**<br>
[Обновите luma3DS](http://3ds.customfw.xyz/update-luma3ds) до версии [7.0.5](https://github.com/AuroraWright/Luma3DS/releases/tag/v7.0.5)
  ...
  + Выберите файл с бекапом, который вы создали во время даунгрейда до 2.1 и нажмите (А) (бекап должен лежать папке files9 на карте памяти)? если у вас нет оригинального бекапа прошивки, сделанного до установки a9lh, то у меня для вас плохие новости.
<br><br>
