...
header:
  ...
  cta_url: "/get-started"
  caption:
excerpt: 'Полное руководство по прошивке 3DS, <br /> от начала до boot9strap.<br /><br />**Последнее изменение: <br />6 августа 2017<br /><br />**'
---

{% include toc title="Разделы" %}

Уехал в отпуск. До 17го августа 2017 обновлений не будет, разве что произойдет что-то эпохальное! 
{: .notice--warning}
