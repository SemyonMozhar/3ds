...
header:
  ...
  cta_url: "/get-started"
  caption:
excerpt: 'Полное руководство по прошивке 3DS, <br /> от начала до boot9strap.<br /><br />**Последнее изменение: <br />18 августа 2017<br /><br />**'
---
...
Кастомную прошивку можно установить на любую приставку с версией прошивки 11.5.0 или ниже, однако в некоторых случая могут понадобится дополнительные технические средства. Подробнее об этом вы узнаете читая руководство.
...
+ Инструкция предназначена для всех приставко семейства 3DS любых регионов на прошивке 11.5.0 или ниже
