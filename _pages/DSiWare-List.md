...
Каждая часть отсортирована по цене от меньшей к большей.
{: .notice--info}

QR-коды можно отсканировать, нажав (L) + (R) на домашнем экране и выбрав иконку QR на нижмен экране приставки.
{: .notice--info}

Требования связанные с размером появились из-за того, что измененная игра и ее сохранение не должны измениться в размере, иначе Перенос данных не пройдет корректно. Простыми словами, игра -донор должна быть достаточно большой, чтобы вместить взлом.
{: .notice--info}
...
##### <a name="usa" />Совместимые игры USA-региона
...
##### <a name="eur" />Совместимые игры EUR-региона
...
##### <a name="jpn" />Совместимые игры JPN-региона
