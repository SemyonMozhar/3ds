...
<br><br>
Часто мне задают вопрос можно ли перенести NAND с одной системы на другую? 
NAND шифруется уникальным для каждой консоли ключом, поэтому перенос невозможен. 
<br><br>
