...
1. Скачайте [загрузчик otherapp](https://smealum.github.io/3ds/#otherapp), соответствующий версии прошивки **целевой 3DS**.
...
1. Если игры нет совсем, следует соединить NNID, с которого была куплена игра, с **целевой 3DS** и перекачать игру на нее.
  + Попробуйте сначала удалить игру через "Управление данными" (Data Management) в системных настройках (System Settings).
  + Если на **целевой 3DS** не самая последняя версия ПО (без нее в eShop не зайти), то обратите внимание на этот способ - [DSiWare Downgrade - Часть IV - ctr-httpwn](dsiware-downgrade#section-iv---ctr-httpwn).
2. На **исходной 3DS** выполните следующие инструкции: [DSiWare даунгрейд - Часть III - Установка файла сохранения](dsiware-downgrade#section-iii---installing-the-save)
