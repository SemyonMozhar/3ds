...
1. Скопируйте `GodMode9.firms` из `.zip-архива` GodMode9 в директорию `/luma/payloads/` на SD-карте
...
## <a name="b9s" />Черный экран при загрузке SysNAND после установки b9s
