...
{% capture notice-4 %}
Этот метод требует от вас произвести Передачу данных системы ([System Transfer](http://en-americas-support.nintendo.com/app/answers/detail/a_id/13996/)) из приставки с кастомной прошивкой на приставку со стоковой прошивкой. Перенос данных будет работать *только* в одном из следующих направлений: 
  + New 3DS -> New 3DS
...
* Архив с NFIRM, соответствующий версии **целевой 3DS**:
...
4. Скопируйте `.app` из архива с эксплойтом для инжекта, соответствующего региону консоли в корень КП **исходной 3DS**.
...
После того, как вы окончите выполнение инструкций, созданная в этой части резервная копия может быть использована для восстановления сохранений DSiWare-игр. Удалите DSiWare-игры из системной памяти и восстановите их же из карты памяти.
{: .notice--info}
...
5. Перейдите в `SYSNAND TWNLN` -> `title` -> `00030004` -> `(8-ми значный ID)`
  + 8-ми значный ID смотрите в [списке совместимых DSiWare-игр](dsiware-list).
...
15. Выберите "Mount as FAT image"
  + Если вы не видите такого пункта, убедитесь, что вы запускаете свежую версию программы [GodMode9](https://github.com/d0k3/GodMode9/releases/latest)
  + Если вы не видите этой опции даже на крайнем коммите, [напишите об этом](https://github.com/d0k3/GodMode9/issues).
19. Вы попадете в главное меню.
