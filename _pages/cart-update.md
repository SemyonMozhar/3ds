...
* [Картридж](http://www.3dsdb.com/) (англ.), содержащий версию прошивки, на которую вы хотите обновиться 

#### <a name="instructions" />Инструкция

1. Загрузите приставку в режим восстановления, зажав одновременно (L)+(R)+(A)+(ВВЕРХ) при включении консоли
1. Если будет предложено обновиться, откажитесь и перезагрузите консоль
1. Перезагрузите устройство
1. Вставьте картридж в консоль
1. Запустите игру
